...
namespace SAE_APIGestion.Controllers.Tests
{
    ...
    public class DonneesCapteurControllerTests : BaseTest
    {
        ...
        //[TestMethod()]
        //public async Task PutDonnesCapteurTest()
        //{
        //    // Arrange         
        ...
        //    Assert.IsNotNull(donnesRecuperee, "La donnees n'a pas été trouvée dans la base de données après la mise à jour");
        //    Assert.AreEqual(donneesCapteurUpdate.Valeur, donnesRecuperee.Valeur, "La valeur de la donnees mise à jour ne correspond pas");
        //}
